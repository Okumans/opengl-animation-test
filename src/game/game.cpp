...
void Game::setup() {
  ...
  WorldObject &city =
      m_objects.emplace<WorldObject>(ModelManager::copy(ModelName::CITY));
  city.setScale(2.0f);
  city.setPosition({0.0f, 0.0f, 0.0f});
...
void Game::playerDance() { m_player.ensureInitialized()->dance(); }
