# Animation Test - Naming Conventions & Practices
...
1. Use the resource setup helper lambdas in `App::_setupResources()`.
...
1. Consume assets only through managers.
...
1. Ensure manager initialization guarantees remain valid.
